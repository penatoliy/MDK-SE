...
namespace Malware.MDKServices
{
    ...
    /// </summary>
    public partial class MDKOptions : INotifyPropertyChanged
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static MDKOptions Load([NotNull] string projectFileName, string projectName = null)
        {
            ...
            if (!File.Exists(fileName))
                return new MDKOptions(fileName, name, false);
            ...
            try
            {
                ...
                var result = new MDKOptions(fileName, name, true)
                {
            ...
            {
                throw new MDKOptionsException($"An error occurred while attempting to load project information from {fileName}.", e);
            }
        }
        ...
        MDKOptions(string fileName, string name, bool isValid)
        {
            FileName = fileName;
            if (fileName != null)
        ...
        public void Save()
        {
            ...
            {
                throw new MDKOptionsException($"An error occurred while attempting to save project information to {FileName}.", e);
            }
        }
