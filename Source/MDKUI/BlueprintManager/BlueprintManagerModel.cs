...
namespace Malware.MDKUI.BlueprintManager
{
    ...
    public class BlueprintManagerDialogModel : DialogViewModel
    {
        ...
        void Delete()
        {
            ...
            {
                SendMessage(Resources.BlueprintManagerDialogModel_Delete_Error, string.Format(Resources.BlueprintManagerDialogModel_Delete_Error_Description, e.Message), MessageEventType.Error);
            }
        }
